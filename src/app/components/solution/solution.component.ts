...
export class PostComponent implements OnInit {
  ...
  share(social: string) {
    if (social === 'facebook') {
      ...
      const message = `Hi! I've recently developed a Global Solutions Lab solution titled ${this.solution.title}. I would greatly appreciate your insights and feedback to enhance its effectiveness`;
      ...
      const url = `mailto:?subject=Global Solutions Lab Solution Invitation &body=Hi! I've recently developed a solution titled ${this.solution.title}. I would greatly appreciate your insights and feedback to enhance its effectiveness! https://new-worldgame.web.app/solution-view-external/${this.solution.solutionId}`;
      window.open(url, '_blank');
